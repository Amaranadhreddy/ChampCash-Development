...
public class FailurePageActivity extends Activity {

    private TextView textMobileNumber_prepaid;
    private TextView textOperator_prepaid;
    private TextView textAmount_prepaid;
    ...
    public void onBackPressed(){
        Intent tabIntent = new Intent(FailurePageActivity.this, RechargeActivity.class);
